...
rm_source -file $TCL_USER_REDHAWK_IN_DESIGN_PRE_SCRIPT -optional -print "TCL_USER_REDHAWK_IN_DESIGN_PRE_SCRIPT"
...
if {$REDHAWK_SCENARIO != ""} {
	...
	set REDHAWK_SCENARIO  [get_object_name [get_scenario [current_scenario]]]
	set_app_options -name rail.scenario_name -value $REDHAWK_SCENARIO
}
...
rm_source -file $TCL_USER_REDHAWK_IN_DESIGN_POST_SCRIPT -optional -print "TCL_USER_REDHAWK_IN_DESIGN_POST_SCRIPT"
...
rm_logparse $LOGS_DIR/redhawk_in_design_pnr.log

...
set mode1 				"WC" ;# name for mode1	
set mode_constraints($mode1)            "./data/aes_cipher_top.sdc" ;# for mode1 specific SDC constraints

## Corner constraints; expand it as needed
set corner1 				"WC" ;# name of corner1	
set corner_constraints($corner1)        "./data/corner_constraints.tcl" ;# for corner1 specific SDC constraints 

set corner2 				"BC" ;# name of corner2	
set corner_constraints($corner2)        "./data/corner_constraints.tcl" ;# for corner2 specific SDC constraints 
...
set scenario_constraints($scenario1)    "./data/aes_cipher_top.sdc" ;# for scenario1 specific SDC constraints

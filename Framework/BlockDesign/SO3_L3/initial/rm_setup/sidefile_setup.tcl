...
set ROUTING_LAYER_DIRECTION_OFFSET_LIST                 "{M0 horizontal 0.012} {M1 vertical 0.030} {M2 horizontal 0.012} {M3 vertical 0.0} {M4 horizontal 0.0} {M5 vertical 0.0} {M6 horizontal 0.0} {M7 vertical 0.0} {M8 horizontal 0.0} {M9 vertical 0.0} {M10 horizontal 0.0} {M11 vertical 0.0} {M12 horizontal 0.0} {M13 vertical 0.0}" ;# Specify the routing layers as well as their direction and offset in a list of space delimited pairs;
...
set MIN_ROUTING_LAYER                                   "M0" ;# Optional; Min routing layer name; normally should be specified; otherwise tool can use all metal layers
...
set TCL_LIB_CELL_DONT_USE_FILE                          "./data/dont_use.tcl" ;# Optional; A Tcl file for customized don't use ("set_lib_cell_purpose -exclude <purpose>" commands)

...
} ;# INIT_DESIGN_INPUT == ASCII || INIT_DESIGN_INPUT == RTL
...
## Also sourced before tap cell insertion in rm_icc2_dp_flat_scripts/create_floorplan.tcl (ICC2-RM) or rm_fc_dp_flat_scripts/create_floorplan.tcl (FC-RM)

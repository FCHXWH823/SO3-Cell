...
#set INITIALIZE_FLOORPLAN_UTIL        "0.4" ;# (default) configure initialize_floorplan with -core_utilization
set INITIALIZE_FLOORPLAN_UTIL        "" ;# (default) configure initialize_floorplan with -core_utilization
...
##########################################################################################
set DP_HIGH_CAPACITY_MODE "true" ;# Enables outline view for N2G flow (NETLIST2GDS_FLOW == true).
